...
main:  ; main
	mov dword eax, 5  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=6, column=14, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=5, value=5]))
	push dword eax  ; Push var: a
sec_1:  ; If container at: 10:2
	mov dword eax, 0  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=10, column=5, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=0, value=0]))
	cmp eax, 0
	jne .sec_1_0
	mov dword eax, 1  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=12, column=12, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=1, value=1]))
	cmp eax, 0
	jne .sec_1_1
	jmp .sec_1_end  ; Jump to end if Else is not present
.sec_1_0:  ; If node at: 10:2
	mov eax, esp
	sub eax, 20
...
.sec_1_1_cln:
	add esp, 0  ; Free mem
	jmp .sec_1_finally  ; Jump to final
.sec_1_finally:  ; Finally node at: 14:4
	mov eax, esp
	sub eax, 104
	push eax  ; Setup array pointer
	sub esp, 100
...
.sec_1_end:
sec_2:  ; While at: 18:2
	mov dword ebx, 0  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=18, column=12, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=0, value=0]))
	push ebx
...
.sec_2:  ; While condition
	...
	mov dword ebx, 1  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=20, column=10, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=1, value=1]))
	push ebx
	mov eax, [esp + 4]  ; compileLoadVarNum(VarNumNode(a, pointer=false, arrayOffset=false)): local
	push eax
	pop eax
	pop ebx
	sub eax, ebx  ; VarNumNode(a, pointer=false, arrayOffset=false) lu.pcy113.l3.lexer.TokenType[MINUS, fixed=true, string=false, charValue=-] NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=20, column=10, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=1, value=1]) -> eax
	push eax
...
.sec_2_end:
sec_3:  ; For at: 27:2
	mov dword eax, 0  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=27, column=18, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=0, value=0]))
	push dword eax  ; Push var: x
.sec_3:
	mov dword ebx, 10  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=27, column=25, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=10, value=10]))
	push ebx
	...
	call sd_18  ; print
	add dword esp, 4  ; Free mem from fun call
	mov dword ebx, 1  ; compileComputeExpr(NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=27, column=35, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=1, value=1]))
	push ebx
	mov eax, [esp + 4]  ; compileLoadVarNum(VarNumNode(x, pointer=false, arrayOffset=false)): local
	push eax
	pop eax
	pop ebx
	add eax, ebx  ; VarNumNode(x, pointer=false, arrayOffset=false) lu.pcy113.l3.lexer.TokenType[PLUS, fixed=true, string=false, charValue=+] NumLitNode(lu.pcy113.l3.lexer.tokens.NumericLiteralToken[line=27, column=35, type=lu.pcy113.l3.lexer.TokenType[NUM_LIT, fixed=false, string=false], literal=1, value=1]) -> eax
	push eax
...
sd_18:  ; print
	lea eax, [esp]
	sub eax, 48
	push eax  ; Setup empty pointer str -> sd_17
	sub esp, 44
...
section .data
	esp_start dd 0
	var_1 dd 99, 100, 101, 0  ; 11:21
	var_2 dd 49, 50, 51, 0  ; 13:21
	var_3 dd 119, 104, 121, 32, 99, 97, 110, 32, 105, 32, 101, 118, 101, 110, 32, 100, 111, 32, 116, 104, 105, 115, 32, 63, 0  ; 15:21
	var_4 dd 101, 108, 115, 101, 0  ; 22:21
