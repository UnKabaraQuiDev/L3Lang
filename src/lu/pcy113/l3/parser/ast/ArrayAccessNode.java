...
public class ArrayAccessNode extends Node implements RecursiveArithmeticOp {

	private IdentifierToken mainIdent, childIdent;
	private boolean arrayOffset = false;

	public ArrayAccessNode(IdentifierToken mainIdent) {
		this.mainIdent = mainIdent;
	}

	public ArrayAccessNode(IdentifierToken mainIdent, Node offset) {
		add(offset);
		this.mainIdent = mainIdent;
		this.arrayOffset = true;
	}

	public ArrayAccessNode(IdentifierToken mainIdent, IdentifierToken childIdent) {
		this.childIdent = childIdent;
		this.mainIdent = mainIdent;
	}

	public ArrayAccessNode(IdentifierToken mainIdent, IdentifierToken childIdent, Node offset) {
		add(offset);
		this.childIdent = childIdent;
		this.mainIdent = mainIdent;
		this.arrayOffset = true;
